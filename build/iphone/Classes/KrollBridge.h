...
@interface bookBindingExObject : KrollCoverageObject {
#else
@interface bookBindingExObject : KrollObject {
#endif
@private
...
extern NSString * bookBindingEx$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	bookBindingExObject *_bookbindingex;
    KrollObject* console;
	BOOL shutdown;
