...
/**
 Base class for all bookBindingEx views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the bookBindingEx view hierarchy (such as wrapped iOS UIViews) was touched.
