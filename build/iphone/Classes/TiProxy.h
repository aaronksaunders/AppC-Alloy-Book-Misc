...
//Rare exceptions to indicate a bug in the _bookbindingex code (Eg, function that a subclass should have implemented)
...
/**
 The base class for bookBindingEx proxies.
 */
