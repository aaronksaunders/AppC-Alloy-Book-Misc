...
//@interface bookBindingExObject : NSObject
//@end

@interface bookBindingExObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[bookBindingExObject class]])
		{
			for (NSString *key in [[(bookBindingExObject*)o modules] allKeys])
			{
