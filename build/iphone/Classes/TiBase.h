...
// in simulator we redefine to format for bookBindingEx Developer console
...
{\
	NSString * exceptionName = [@"org.bookbindingex." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bookbindingex";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIbookBindingExNativeItemNone = -1, 
	UIbookBindingExNativeItemSpinner = -2,
	UIbookBindingExNativeItemProgressBar = -3,
	
	UIbookBindingExNativeItemSlider = -4,
	UIbookBindingExNativeItemSwitch = -5,
	UIbookBindingExNativeItemMultiButton = -6,
	UIbookBindingExNativeItemSegmented = -7,
	
	UIbookBindingExNativeItemTextView = -8,
	UIbookBindingExNativeItemTextField = -9,
	UIbookBindingExNativeItemSearchBar = -10,
	
	UIbookBindingExNativeItemPicker = -11,
	UIbookBindingExNativeItemDatePicker = -12,
	
	UIbookBindingExNativeItemInfoLight = -13,
	UIbookBindingExNativeItemInfoDark = -14,
	
	UIbookBindingExNativeItemDisclosure = -15,
	
	UIbookBindingExNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all bookBindingEx instances of
